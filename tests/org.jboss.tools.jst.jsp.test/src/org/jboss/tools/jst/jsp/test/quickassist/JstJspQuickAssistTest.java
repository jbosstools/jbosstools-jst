 ...
 ******************************************************************************/
package org.jboss.tools.jst.jsp.test.quickassist;
...
import org.jboss.tools.jst.jsp.internal.html.text.correction.IgnoreAttributeNameCompletionProposal;
...
public class JstJspQuickAssistTest extends TestCase {
	...
	public void testWSTQuickAssistProcessors() throws CoreException {
		checkProposalExistance(project, PAGE_NAME, TEST_STRING, 0, 
				IgnoreAttributeNameCompletionProposal.class);
	}
	
	
	private void checkProposalExistance(IProject project, String fileName, String str, int id, Class<? extends ICompletionProposal> proposalClass) throws CoreException {
		...
		try{
			...
			fail("Quick fix: "+proposalClass+" not found");
		}finally{
