...
import org.jboss.tools.jst.web.ui.internal.editor.bundle.BundleMap.BundleEntry;
...
public class ExternalizeStringsWizardPage extends WizardPage {
	...
	public ExternalizeStringsWizardPage(String pageName, BundleMap bm, IDocument document, ISelectionProvider selectionProvider) {
		...
		propsKeyStatus = new Status(IStatus.OK, WebUiPlugin.PLUGIN_ID, Constants.EMPTY);
		propsValueStatus = new Status(IStatus.OK, WebUiPlugin.PLUGIN_ID, Constants.EMPTY);
		duplicateKeyStatus = new Status(IStatus.OK, WebUiPlugin.PLUGIN_ID, Constants.EMPTY);
		duplicateValueStatus = new Status(IStatus.OK, WebUiPlugin.PLUGIN_ID, Constants.EMPTY);
	}
	...
	private void initializeFieldsAndAddLIsteners() {
		...
		if (ExternalizeStringsUtils.isSelectionCorrect(sel)) {
			 ...
			 */
			if (bm == null) {
				WebUiPlugin.getDefault().logWarning(
