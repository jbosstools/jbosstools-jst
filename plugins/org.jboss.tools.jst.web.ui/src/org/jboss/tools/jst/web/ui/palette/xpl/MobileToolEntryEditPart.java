...
public class MobileToolEntryEditPart extends PaletteEditPart {
	static final int ARROW_WIDTH = 0; // 9;
	...
	public MobileToolEntryEditPart(PaletteEntry paletteEntry) {
		super(paletteEntry);
	}
	...
	protected AccessibleEditPart createAccessible() {
		return new AccessibleGraphicalEditPart() {
			...
			public void getRole(AccessibleControlEvent e) {
				if (getParent() instanceof IPaletteStackEditPart
						&& (MobileToolEntryEditPart.this == ((IPaletteStackEditPart) getParent())
								.getActiveEntry())) {
