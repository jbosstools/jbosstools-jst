...
public class BundleMap {
    ...
    boolean showBundleUsageAsEL = WebUiPlugin.getDefault().getPreferenceStore().getBoolean(
	...
	public void updateShowBundleUsageAsEL() {
		updateShowBundleUsageAsEL(WebUiPlugin.getDefault().getPreferenceStore().getBoolean(
				IVpePreferencesPage.SHOW_RESOURCE_BUNDLES_USAGE_AS_EL));
	}
