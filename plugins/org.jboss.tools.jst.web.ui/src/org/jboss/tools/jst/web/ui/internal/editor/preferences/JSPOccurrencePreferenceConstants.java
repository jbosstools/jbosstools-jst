...
public class JSPOccurrencePreferenceConstants extends XMLOccurrencePreferenceConstants {
	...
	public static void initializeDefaultValues(IPreferenceStore store) {
		...
		store.setDefault(PreferenceKeyGenerator.generateKey(EDITOR_OCCURRENCE_PROVIDER,JSPUIPlugin.ID), "org.jboss.tools.jst.web.ui.internal.editor.defaultOccurenceProvider"); //$NON-NLS-1$
