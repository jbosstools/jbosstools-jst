...
public interface WebAppConstants {
    public String DOC_QUALIFIEDNAME = "web-app"; //$NON-NLS-1$
    public String DOC_PUBLICID      = "-//Sun Microsystems, Inc.//DTD Web Application 2.2//EN"; //$NON-NLS-1$
    public String DOC_PUBLICID_2_3  = "-//Sun Microsystems, Inc.//DTD Web Application 2.3//EN"; //$NON-NLS-1$
    public String DOC_EXTDTD        = "http://java.sun.com/j2ee/dtds/web-app_2_2.dtd"; //$NON-NLS-1$
