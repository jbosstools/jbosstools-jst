...
public class CollapsibleSetAttributeProvider extends JQueryMobileAttrProvider {
	...
	private static final JQueryMobileAttribute[] requiredAttributes = new JQueryMobileAttribute[] {new DataRoleAttribute("", COLLAPSIBLE_SET)};

	private static final JQueryMobileAttribute[] conditionalAttributes = new JQueryMobileAttribute[] {DATA_COLLAPSED_ICON_ATTRIBUTE,
