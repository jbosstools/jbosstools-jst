...
public class FlipToggleSwitchAttributeProvider extends JQueryMobileAttrProvider {
	...
	private static final JQueryMobileAttribute[] requiredAttributes = new JQueryMobileAttribute[] {new DataRoleAttribute("", SLIDER)};

	private static final JQueryMobileAttribute[] conditionalAttributes = new JQueryMobileAttribute[] {DATA_MINI_ATTRIBUTE,
