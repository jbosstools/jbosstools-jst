 ...
 */
public class ScriptAttributeProvider extends FileNameAttributeProvider {

	private static final AttributeData TYPE_ATTRIBUTE = new AttributeData("type", "text/javascript");
	private static final String ATTRIBUTE_NAME = "src";
	private static final String EXTENSION = "js";

	@Override
	protected boolean checkComponent() {
		return !checkAttribute(TYPE_ATTRIBUTE.getName()) || checkAttribute(TYPE_ATTRIBUTE);
	}
