 ...
 */
public class HeaderAttributeProvider14 extends JQueryMobileAttrProvider {

	static final HtmlAttribute[] REQUIRED_ATTRIBUTES = new HtmlAttribute[] {new HtmlAttribute(DATA_ROLE, "", new String[]{HEADER})};
