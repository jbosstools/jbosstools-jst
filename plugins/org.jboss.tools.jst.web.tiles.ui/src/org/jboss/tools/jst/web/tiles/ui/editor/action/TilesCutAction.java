...
final public class TilesCutAction extends DiagramCutAction {

	public TilesCutAction(IWorkbenchPart editor) {
		super(editor);
	}

	protected Command createCommand(List objects) {
		return TilesCommandFactory.createCutCommand(objects);
	}
