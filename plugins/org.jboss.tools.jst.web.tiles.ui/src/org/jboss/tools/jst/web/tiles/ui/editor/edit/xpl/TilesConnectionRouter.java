 ...
 * and target anchors.
 */
public final class TilesConnectionRouter extends AbstractRouter {
...
/**
 * Method is not used and will be deleted
 */
int getColumnNear(Connection connection, int r, int n, int x) {
