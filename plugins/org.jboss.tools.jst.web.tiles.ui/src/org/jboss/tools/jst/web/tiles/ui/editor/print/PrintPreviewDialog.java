 ...
 ******************************************************************************/ 
package org.jboss.tools.jst.web.tiles.ui.editor.print;
...
public class PrintPreviewDialog extends Dialog {
			...
			public class SliderPanel extends Composite{
				...
				public SliderPanel(Composite parent, int style) {
					...
					percent.setText(String.valueOf((int)(PageFormat.printScale*100))+"% of normal size"); //$NON-NLS-1$
					...
					sc.addSelectionListener(new SelectionListener(){
						public void widgetSelected(SelectionEvent e){
							percent.setText(String.valueOf(sc.getSelection())+"% of normal size"); //$NON-NLS-1$
							percent.redraw();
			...
			public class ControlPanel extends Composite implements PaintListener{
				...
				public ControlPanel(Composite parent, int style) {
					...
					print.setText(WebUIMessages.PRINT);
					print.setLayoutData(data);
					data = new GridData();
					data.horizontalAlignment = GridData.BEGINNING;
					data.horizontalIndent = 8;
					Label zoom = new Label(this,SWT.NONE);
					zoom.setText(WebUIMessages.ZOOM);
			...
			public String open () {
				...
				dialog.setText(WebUIMessages.PRINT_PREVIEW);
				...
				ok.setText(WebUIMessages.PRINT);
				data = new GridData();
				data.widthHint = 75;
				...
				cancel.setText(WebUIMessages.CLOSE);
