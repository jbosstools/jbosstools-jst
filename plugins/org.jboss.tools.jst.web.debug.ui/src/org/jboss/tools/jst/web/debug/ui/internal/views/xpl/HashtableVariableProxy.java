 ...
 * @author Jeremy
 */
public class HashtableVariableProxy extends VariableProxy {
	/**
	 * @param origin
	 */
	HashtableVariableProxy(StackFrameWrapper frameWrapper, IVariable origin) {
		super(frameWrapper, origin);
	}
	/**
	 * @param origin
	 */
	HashtableVariableProxy(StackFrameWrapper frameWrapper, IVariable origin, String alias) {
